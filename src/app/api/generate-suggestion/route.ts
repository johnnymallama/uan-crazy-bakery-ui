...
function buildPrompt(orderData: any, customizationText: string): string {
  ...
  prompt += `4.  **Formato:** Tu respuesta debe ser una única descripción mejorada y detallada de la decoración final. No ofrezcas varias opciones. Debe ser un párrafo coherente y atractivo que el cliente pueda leer y confirmar. **IMPORTANTE: La respuesta NO debe superar los 1500 caracteres en total. Sé conciso y directo.**\n`;
